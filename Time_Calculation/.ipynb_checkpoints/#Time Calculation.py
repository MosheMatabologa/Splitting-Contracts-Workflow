...
df['Clock Out Time'] = pd.to_datetime(df['Clock Out Time'], format='%H:%M')       #df['Clock Out Time'].astype('datetime64[ns]')
df['Clock In Time'] = pd.to_datetime(df['Clock In Time'], format='%H:%M')        #df['Clock In Time'].astype('datetime64[ns]')
